        ...
        <div id="body_mid_right">
            <div id="body_mid_mid">
                                ...
                                <div class="tabel_wrapper">
                                    <table class="standaard_tabel" border = "0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <th >f</th>
                                            <th >vs</th>
                                            <th style="border-width: 0;">cc</th>
                                        </tr>
                                        <tr onClick="javascript:location.href='bestemming_form'">
                                            <td >3</td>
                                            <td>a</td>
                                            <td>b</td>
                                            <td>c</td>
                                        ...
                                        <tr onClick="javascript:location.href='bestemming_form'" style="border-width: 0;">
                                            <td>lul</td>
                                            <td>werfw</td>
                                            <td>asc</td>
                                            <td>vd</td>
                                            <td style="border-width: 0;">njyj</td>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="frame_right">
                    <?php echo $this->element('top_reizen_groot'); ?>
                </div>
