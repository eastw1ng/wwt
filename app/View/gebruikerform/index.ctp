                    ...
                    <div class="frame_left_mid_right">
                        <div class="frame_left_mid_mid form_img_placement">
							...
							<div class="form_container">
								...
								<div class="form_sub_container">
									<div class="form_head">
										<span style="margin-left:1px;">Klantnummer</span>
									</div>
									<div class="form_content">
								...
								<div class="form_sub_container">
									<div class="form_head">
										<span style="margin-left:1px;">Rechten</span>
									</div>
									<div class="form_content">
										<select class="global_select" style="width:170px;">
										  <option value="1">Recht 1</option>
										  <option value="2">Recht 2</option>
										  <option value="3">Recht 3</option>
										</select>
										<span class="form_notes"> *</span>
									</div>
									<div style="clear: both;"></div>
